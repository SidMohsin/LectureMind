...
export default function LectureRow({ lecture, onOpen, onDelete }) {
  ...
  return (
    <div className="lecture-row">
      <div
        className="lecture-row-main"
        onClick={() => onOpen(lecture.lecture_id)}
        role="button"
        tabIndex={0}
      ...
      >
        ...
        <div className="lecture-row-text">
          ...
          <span className="lecture-row-meta">
            ...
            {lecture.question_count > 0 && ` · ${lecture.question_count} ${lecture.question_count === 1 ? 'question' : 'questions'}`}
          </span>
        </div>
      </div>
